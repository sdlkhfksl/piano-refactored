export default [
  ...
  {
    name: '青花瓷',
    content: `hhfdfdfdsp dfdso dfdsp sd of<br>
  ...
  lyrics: '' },
  { name: '不能说的秘密',
  content: 'WTTT WRRR WTTT WYYY WTTT WRRR WTTT WYYY WIIII IUU IIIOUYTRRT </br>    WOOOO OII OOOOOIIUUY WIIII IUU IIIOUYTRRYT ETOPT OOOOOIIUUY </br>    TSASSOOOOIIU TSASSOOOODDS TSASAPTAPAPO TPOPOIIUIOPPO </br>    TSASSOOOOIIU TSASSOOOODDS TSASAP TAPAPO TPOPOIIUIUIOPPO TOTIU TTOTIUT',
  degree: 1,
  author: '',
  authorLink: '',
  lyrics: '' },
